 ...
 */
public class MvvmxDialogView extends AbstractComponentView<MvvmxDialogViewModel, MvvmxDialogComponent> {
    ...
    public MvvmxDialogView(MvvmxDialogViewModel viewModel, Stage stage) {
        super(viewModel);
        this.stage = stage;
    }
